...
<div id="panel_bottom" class="panel_bottom" style="z-index:10;text-align:center;font-size:10px;cursor:default">
	...
	<div style="display:inline-block;width:25%;text-align:center;cursor:default">
		...
		<div id="bottom_login" style="margin:auto;width:50px;cursor:pointer;color:#000000;font-weight:bold;">
			<img src="img/bottom_5_a.png" style="width:22px;margin-bottom:2px;"><br>
...
var oFlicking = new jindo.m.Flicking(jindo.$('mflick'),{
		...
		'beforeFlicking' : function(oCustomEvt){
			...
			if(oCustomEvt.bLeft){
				...
				$("#li"+next).children("div").css("border-bottom", "2px solid teal");
			}else{
				...
				$("#li"+prev).children("div").css("border-bottom", "2px solid teal");
			}
			},
...
$('.category').live("click", function(){
	...
	$(this).children("div").css("border-bottom", "2px solid teal");
	var n = $(this).data('categoryno');
	oFlicking.refresh(n);
})
