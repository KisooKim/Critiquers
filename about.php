...
<script>(function(d, s, id) {
	...
	js.src = "//connect.facebook.net/ko_KR/sdk.js#xfbml=1&version=v2.8&appId=493328504033025";
 ...
 <div class="about_container">
	<div class="about_landing">
		<div style="padding-top:210px;">
			<img src = "img/logo/logo.png" style="width:160px;">
			<br>
			<span style="font-size:14px;">독자가 언론을 평가하는 뉴스 큐레이션</span>
		</div>
	</div>
	...
	언론평가 프로젝트입니다</div>
	<div class="about_description"><크리티커스>는 독자가 언론을 직접 평가하고 견제하도록 하는 공공프로젝트인 동시에 좋은 저널리즘 컨텐츠를 선별하는 미디어 큐레이션 서비스입니다. <크리티커스>에서는 누구나 읽은 뉴스를 0점부터 5점까지 자유롭게 평가할 수 있습니다. 이 평가는 그 뉴스 뿐 아니라 그 뉴스를 쓴 기자, 그리고 그 기자가 소속된 언론사에도 누적됩니다. <크리티커스>는 독자가 직접 평가내린 각 언론사와 기자의 평점을 상시적으로 공개하며 높은 평점을 받은 뉴스를 소개해드립니다.</div>
	</div>
	...
	<div class="about_description">사람들은 주로 자신과 정치적 성향이 가까운 매체를 통해 정보를 접합니다. 게다가 소셜미디어를 통해 뉴스가 전파되는 최근에는 비슷한 성향의 사람끼리 비슷한 정보를 공유하는 "공론장의 진영화"가 더욱 심각한 문제가 되고 있습니다. 더 나은 사회적 선택이 이루어지기 위해서는, 비록 다른 성향의 매체이더라도 가치있는 주장과 정보라면 널리 읽혀져야 합니다. <크리티커스>는 보수부터 중도와 진보까지, 일간신문부터 인터넷매체와 블로거까지, 여러 언론을 비교하기 쉽게 소개함으로써 공론장의 진영화를 극복하고자 합니다.</div>
	</div>
...
//include("footer.php");
?>
<div class="toast toast_signout" style="display:none;z-index:30;">
</div>
