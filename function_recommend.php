...
$sql3 = "SELECT no from c_rating WHERE user_id='$user_id' AND article_no='$article_no'";
...
if($no){
	...
	$sql = "INSERT INTO c_rating(user_id, facebook_id, ip_address, date_int, article_no, media_no, author_no, rating, facebook_thattime, twitter_thattime) VALUES('$user_id', '$facebook_id', INET_ATON('$ip'), '$date_int', '$article_no', '$media_no', '$author_no', '$rating', '$facebook_no', '$twitter_thattime') ON DUPLICATE KEY UPDATE rating='$rating'";
	$query = mysql_query($sql, $connect);
	$love = "yes";
}
...
$total_value = round($facebook_no*max(1.1, log($morethanthree)));

/* 평점과 SNS 총점을 업데이트 해준다 */

//b_article_all
$sql1 = "UPDATE b_article_all SET rate_total='$rate_total', rated_time='$rated_time', rate_value='$rate_value', total_value='$total_value' WHERE  no='$article_no'";
$result1 = mysql_query($sql1,$connect);

//b_shared_category
$sql2 = "UPDATE b_article_shared_1 SET rate_total =  '$rate_total', rated_time =  '$rated_time', rate_value =  '$rate_value', total_value='$total_value' WHERE no = '$article_no'";
$result2 = mysql_query($sql2,$connect);

//b_shared_category
$sql3 = "UPDATE b_article_shared_$categoryno SET rate_total =  '$rate_total', rated_time =  '$rated_time', rate_value =  '$rate_value', total_value='$total_value' WHERE no = '$article_no'";
$result3 = mysql_query($sql3,$connect);

//z_media_number
$sql5 = "UPDATE z_media_$media_no SET rate_total =  '$rate_total', rated_time =  '$rated_time', rate_value =  '$rate_value', total_value='$total_value' WHERE no =  '$article_no'";
