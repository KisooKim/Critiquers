...
<div id="left_panel" style="display:none;position:fixed;top:50%;left:50%;height:348px;width:280px;background-color:#fafafa;z-index:50;font-size:12px;border-radius:20px;text-align:center;transform:translate(-50%, -50%);box-shadow: 0 10px 12px -4px rgba(0, 0, 0, 0.35);">
	...
	<div style="width:100%;border:0px solid teal;text-align:center;">
		<div id="bardate_container" style="width:auto;height:auto;"><? include("media_bar_date.php"); ?></div><? include("media_bar_period.php"); ?>
	</div>
</div>
...
<!-- 상단카테고리 바 -->
<? include("./media_2_bar_category.php"); ?>
</div><!-- div upperbar 종료 -->

<!-- 리스트 출력하는 div -->
<div id="mflick" class="flick-ct" style="margin-bottom:54px">
...
$('rect').live("click", function(){
	...
	$("#li_period_0").css("font-weight", "bold");
	$("#li_period_0").css("background-color", "#eaeaea");

	$('#bardate_container').load('./bar_date.php?date='+dateint+'&showdate='+dateint)
...
$('.categoryperiod').live("click", function(){
	var period_array = ['1일간','3일간','7일간','한달간','반년간','일년간'];
