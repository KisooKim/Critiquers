...
<div id="ratingstars_float" style="display:none;position:fixed;top:70%;bottom:30%;width:290px;height:94px;margin-top:-100px;font-size:42px;text-align:center;left:50%;margin-left:-145px;z-index:10000;font-size:10px;border:1px solid #eaeaea;background-color:#fafafa;border-radius:20px;box-shadow: 0 10px 12px -4px rgba(0, 0, 0, 0.35);padding:0px">
	...
	<div class="ratingstars_submit" style="">평가 제출하기</div>
...
<!-- <div class="" style="position:fixed;bottom:80px;left:50%;margin-left:-80px;width:160px;z-index:4949;font-size:13px;border-radius:20px;border:1px solid #dadada;background-color:#FFF;box-shadow: 0 3px 4px -4px rgba(0, 0, 0, 0.35)">
	<div style="display:inline-block;width:50%;height:30px;padding:8px 4px 7px 7px;text-align:center;color:teal;font-weight:bold;border-right:0px;cursor:pointer;border-right:1px solid #dadada;">
		평점순
	</div><div style="display:inline-block;width:50%;height:30px;padding:8px 7px 7px 4px;text-align:center;color:#5a5a5a;font-weight:bold;cursor:pointer;">
		공유순
	</div>
</div>
-->
...
<div id="header_container">
	<div style="display:table;width:12%;border:0px solid red;text-align:center;float:left;height:100%;display:-webkit-box;-webkit-box-pack:center;-webkit-box-align:center;">
		<img id="person" src="img/personal.png" style="width:30px;height:30px;padding:3px 3px 3px 3px;cursor:pointer;">
	</div><div style="display:inline-block;width:72%;height:100%;text-align:center;">
		<a href="./" style=";"><img class="title_logo" src="img/logo/logo.png"></a>
	</div><div style="display:table;width:12%;border:0px solid red;text-align:center;float:right;height:100%;display:-webkit-box;-webkit-box-pack:center;-webkit-box-align:center;">
		<img id="sand" src="img/sand.png" style="width:30px;height:30px;padding:3px 3px 3px 3px;cursor:pointer;">
	</div>
	<!--로고-->
</div>
<!-- header 종료 -->
...
<div id="panel_bottom" class="panel_bottom" style="z-index:200;text-align:center;font-size:10px;cursor:default">
	<div style="display:inline-block;width:20%;text-align:center;cursor:default">
		<a href="./" style="display:block;margin:auto;width:50px;"><div style="margin:auto;width:50px;">
			<img src="img/bottom_1_a.png" style="width:22px;margin-bottom:2px;"><br>
			<b style="color:teal">랭킹뉴스</b>
		</div></a>
	</div><div style="display:inline-block;width:20%;text-align:center;cursor:default">
		<a href="./cluster.php" style="display:block;margin:auto;width:50px;"><div style="margin:auto;width:50px;">
			<img src="img/bottom_2.png" style="width:22px;margin-bottom:2px;"><br>
			이슈모음
		</div></a>
	</div><div style="display:inline-block;width:20%;text-align:center;cursor:default">
		<a href="./recom.php" style="display:block;margin:auto;width:50px;"><div style="margin:auto;width:50px;">
			<img src="img/bottom_3.png" style="width:22px;margin-bottom:2px;"><br>
			뉴스추천
		</div></a>
	</div><div style="display:inline-block;width:20%;text-align:center;cursor:default">
		<a href="./media.php" style="display:block;margin:auto;width:50px;"><div style="margin:auto;width:50px;">
			<img src="img/bottom_4.png" style="width:22px;margin-bottom:2px;"><br>
			언론순위
		</div></a>
	</div><div style="display:inline-block;width:20%;text-align:center;cursor:default">
		<a href="./private.php" style="display:block;margin:auto;width:50px;"><div style="margin:auto;width:50px;">
...
<div class="toast_normal toast" style="display:none;z-index:4950">
	평가가 반영되었습니다.
</div>
