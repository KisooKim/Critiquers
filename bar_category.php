...
$category_names = array("▩","전체","보수","진보","중도","인디","블로거","비즈·테크","소셜");
?>

<div id="barcategory" style="overflow:hidden;"><div id="category_move1" style="width:10%;float:left;display:inline-block;background-color:transparent"><div class="barcategory_in" style="width:100%;"><div style="padding-top:2px;"><</div></div></div><div id="barcategory_scroll" style="z-index:10;width:80%;overflow-x: scroll;margin:0px;float:left;"><?
